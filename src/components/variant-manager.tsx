      ...
      <table className="w-full text-sm">
        ...
        <tbody>
          {variants.map((variant) => {
            ...
            return (
              <tr key={variant.id} className="border-b border-zinc-100 last:border-0 dark:border-zinc-800">
                <td className="px-4 py-3 font-mono text-xs text-zinc-600 dark:text-zinc-400">{variant.sku}</td>
                <td className="px-4 py-3 text-zinc-900 dark:text-zinc-50">{variant.name}</td>
